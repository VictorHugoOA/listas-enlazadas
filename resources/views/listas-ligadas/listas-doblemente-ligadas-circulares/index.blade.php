...
<div id="div_titulo_h1" align="center">
    <h1>Listas Doblemente Ligadas Circular</h1>
</div>
...
<script src="{{ asset('../js/lista-doblemente-ligada-circular/funciones/index.js') }}"></script>
<script src="{{ asset('../js/lista-doblemente-ligada-circular/inicio/index.js') }}"></script>
        ...
        if(empezar){
            ...
            if(mouseIsDown){
                ...
                if(objetoActual != null){
                    ...
                    //objetoActual.ptrLigaAnterior_estructura.contenedor.
                    objetoActual.ptrLigaAnterior_estructura.contenedor.x = objetoActual.ptrLigaAnterior_estructura.contenedor.x + mov_x;
                    objetoActual.ptrLigaAnterior_estructura.contenedor.y = objetoActual.ptrLigaAnterior_estructura.contenedor.y + mov_y;

                    //objetoActual.ptrLigaAnterior_estructura.titulo.
                    objetoActual.ptrLigaAnterior_estructura.titulo.x = objetoActual.ptrLigaAnterior_estructura.titulo.x + mov_x;
                    objetoActual.ptrLigaAnterior_estructura.titulo.y = objetoActual.ptrLigaAnterior_estructura.titulo.y + mov_y;

                    //objetoActual.ptrLigaAnterior_estructura.valor.
                    objetoActual.ptrLigaAnterior_estructura.valor.x = objetoActual.ptrLigaAnterior_estructura.valor.x + mov_x;
                    objetoActual.ptrLigaAnterior_estructura.valor.y = objetoActual.ptrLigaAnterior_estructura.valor.y + mov_y;
...
function crearNuevoNodo(objDireccionMemoria){
    ...
    console.log(objDireccionMemoria);
    ...
    "key": key_objecto,
        ...
        "ptrLigaAnterior_estructura": {

        "contenedor": {
        "x": pos_actualX + obj_nodo.contenedor_dato.width+obj_nodo.contenedor_ptrLiga.width,
            "y": pos_actualY + obj_nodo.contenedor_direccion_memoria.height,
            "width": obj_nodo.contenedor_ptrLiga.width,
            "height": obj_nodo.contenedor_ptrLiga.height,
    },
        ...
        "titulo": {
        "x": pos_actualX + obj_nodo.contenedor_dato.width + obj_nodo.contenedor_ptrLiga.width + 10,
            "y": pos_actualY + obj_nodo.contenedor_direccion_memoria.height + 22,
    },
    ...
    for(var key in objetos){
        ...
        if(objeto.ptrLigaSig.key != null){
            ...
            if(objeto.ptrLigaSig.key == obj_ptrNodoInicio.nodo_conectado.key){
                ...
                let startX = objeto.ptrLiga_estructura.valor.x +(objeto.ptrLiga_estructura.contenedor.width/2);
                let endY = objInicio.nodo_estructura.titulo_dir_mem.y;
                let startY = objeto.ptrLiga_estructura.valor.y;
        ...
        if(objeto.ptrLigaAnt.key != null){
            if(objeto.ptrLigaAnt.key == obj_ptrNodoFinal.nodo_conectado.key){

                let objFinal = objetos[obj_ptrNodoFinal.nodo_conectado.key];

                let endX = objFinal.nodo_estructura.titulo_dir_mem.x;
                let startX = objeto.ptrLigaAnterior_estructura.valor.x + (objeto.ptrLigaAnterior_estructura.contenedor.width / 2);
                let endY = objFinal.nodo_estructura.titulo_dir_mem.y;
                let startY = objeto.ptrLigaAnterior_estructura.valor.y;
                let middleX = (endX + startX)/2;
                let middleY = (endY + startY)/2;
                let offsetX = canvas.width/2
                ...
                //ptrLigaSig
                let x_inicio = objeto.ptrLigaAnterior_estructura.contenedor.x + 90;
                let y_inicio = objeto.ptrLigaAnterior_estructura.contenedor.y + (objeto.ptrLigaAnterior_estructura.contenedor.height / 2);

                let obj = objetos[objeto.ptrLigaAnt.key];
...
function dibujar_nodo(nodo){ 
    ...
    /*Dibujar contenedor ptrLigaAnterior*/

    ctx.beginPath();
    ctx.lineWidth = 2;
    ctx.fillStyle = obj_nodo.nodo_disenio.relleno_color;
    ctx.strokeStyle = obj_nodo.nodo_disenio.margen_color;
    ctx.rect(nodo.ptrLigaAnterior_estructura.contenedor.x,nodo.ptrLigaAnterior_estructura.contenedor.y, 
        nodo.ptrLigaAnterior_estructura.contenedor.width, nodo.ptrLigaAnterior_estructura.contenedor.height);
    ctx.stroke();
    ctx.fill();
    ...
    ctx.font = obj_nodo.nodo_disenio.texto_font_valores;
    ctx.fillStyle = obj_nodo.nodo_disenio.texto_variables_color;
    ctx.fillText("ptrNodoAnt", nodo.ptrLigaAnterior_estructura.titulo.x, nodo.ptrLigaAnterior_estructura.titulo.y);
    ...
    if(nodo.ptrLigaAnt.inicializado){

        if(nodo.ptrLigaAnt.key !== null){

            ptrNodoAnt = objetos[nodo.ptrLigaAnt.key].direccion_memoria;
    ...
    ctx.fillText(ptrNodoAnt, nodo.ptrLigaAnterior_estructura.valor.x, nodo.ptrLigaAnterior_estructura.valor.y);
