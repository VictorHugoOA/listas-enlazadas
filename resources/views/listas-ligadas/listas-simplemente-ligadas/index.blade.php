...
@section('titulo')
<title>Listas Simplemente Ligadas</title>
@endsection
...
<div id="div_titulo_h1" align="center">
	<h1>Lista Simplemente Ligada</h1>
</div>
...
<script src="{{ asset('../js/lista-simplemente-ligada/funciones/index.js') }}"></script>

<!--funciones listas simplemente ligadas-->
<script src="{{ asset('../js/lista-simplemente-ligada/inicio/index.js') }}"></script>
